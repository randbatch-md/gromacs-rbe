              ...
              const DDBalanceRegionHandler&       ddBalanceRegionHandler)
{
    ...
    if (stepWork.computeSlowForces)
    {
        ...
        //printf("This is called longRangeNonbondeds\n"); 调用了这句
    }
    ...
    {
        //printf("This is called needEarlyPmeResults\n");没调用这句
    ...
    if (needToReceivePmeResultsFromSeparateRank && simulationWork.useCpuPmePpCommunication && !needEarlyPmeResults)
    {
        ...
        //printf("This is called 11\n");没调用这句
    }

    if (stepWork.computeForces)
    {
        //printf("This is called 61\n"); 这句调用了
